" Filename: colors/neurtral.vim

  if &background == 'dark'

  let s:guishade0 = "#000000"
  let s:guishade1 = "#383839"
  let s:guishade2 = "#454548"
  let s:guishade3 = "#67686c"
  let s:guishade4 = "#8a8a90"
  let s:guishade5 = "#acadb4"
  let s:guishade6 = "#cfcfd8"
  let s:guishade7 = "#f1f2fc"
  let s:guiaccent0 = "#ff7d78"
  let s:guiaccent1 = "#feffff"
  let s:guiaccent2 = "#a5a5a5"
  let s:guiaccent3 = "#63a3bf"
  let s:guiaccent4 = "#97becf"
  let s:guiaccent5 = "#57666e"
  let s:guiaccent6 = "#852d2d"
  let s:guiaccent7 = "#b65252"
