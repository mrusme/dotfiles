" Filename: colors/sea.vim

  if &background == 'dark'

  let s:guishade0 = "#333366"
  let s:guishade1 = "#6666cc"
  let s:guishade2 = "#0099cc"
  let s:guishade3 = "#3366cc"
  let s:guishade4 = "#006699"
  let s:guishade5 = "#0066ff"
  let s:guishade6 = "#669999"
  let s:guishade7 = "#99cccc"
  let s:guiaccent0 = "#333399"
  let s:guiaccent1 = "#9999ff"
  let s:guiaccent2 = "#00ccff"
  let s:guiaccent3 = "#6699ff"
  let s:guiaccent4 = "#0099cc"
  let s:guiaccent5 = "#0099ff"
  let s:guiaccent6 = "#66cccc"
  let s:guiaccent7 = "#ccffff"
  ...
  let s:ctermaccent1 = 231
  let s:ctermaccent2 = 222
  let s:ctermaccent3 = 122
  let s:ctermaccent4 = 117
  let s:ctermaccent5 = 111
  let s:ctermaccent6 = 183
  let s:ctermaccent7 = 218
  ...
  let s:guishade0 = "#f1f2fc"
  let s:guishade1 = "#cfcfd8"
  let s:guishade2 = "#acadb4"
  let s:guishade3 = "#8a8a90"
  let s:guishade4 = "#67686c"
  let s:guishade5 = "#454548"
  let s:guishade6 = "#222324"
  let s:guishade7 = "#000000"
  let s:guiaccent0 = "#ff7d78"
  let s:guiaccent1 = "#000000"
  let s:guiaccent2 = "#ffd478"
  let s:guiaccent3 = "#62d9b7"
  let s:guiaccent4 = "#5da3c0"
  let s:guiaccent5 = "#799eff"
  let s:guiaccent6 = "#d783ff"
  let s:guiaccent7 = "#ff89d8"
  let s:ctermshade0 = 231
  let s:ctermshade1 = 252
  let s:ctermshade2 = 249
  let s:ctermshade3 = 245
  let s:ctermshade4 = 102
  let s:ctermshade5 = 238
  let s:ctermshade6 = 235
  let s:ctermshade7 = 16
  let s:ctermaccent0 = 210
  let s:ctermaccent1 = 16
  let s:ctermaccent2 = 222
  let s:ctermaccent3 = 116
  let s:ctermaccent4 = 110
  let s:ctermaccent5 = 111
  let s:ctermaccent6 = 183
  let s:ctermaccent7 = 218
